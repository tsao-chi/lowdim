...
const map_1 = require("@cicadoidea/basic/lib/collection/map");
const repr_1 = require("@cicadoidea/basic/lib/class/repr");
// TODO
...
exports.id_t = id_t;
exports.id_repr = new repr_1.repr_t({
    repr(id) {
        return id.name;
    }
});
class cell_complex_t {
    ...
    *cells() {
    ...
    attach_cmap(dim, id, cmap) {
        assert_1.default(cmap.cod.eq(this.dim_skeleton(dim - 1)));
...
exports.cell_complex_repr = new repr_1.repr_t({
    repr(cell_complex) {
        let s = '';
        // TODO
        return s;
